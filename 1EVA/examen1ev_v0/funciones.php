...
function registra($username,$time){
    ...
    // Crear la fecha y hora actual con el formato 
    $fecha = date("d-m-y H:i");

    // Construir la línea que se guardará en el log
    $linea = "$ip,$username,$fecha\n";

    // Guardar en el archivo registro.log añadiendo al final (modo append)
    file_put_contents("registro.log", $linea, FILE_APPEND);
